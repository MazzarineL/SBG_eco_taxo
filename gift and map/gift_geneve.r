...
env_bota <- env_bota %>% dplyr::filter(garden =="ge")
...
write.csv(df_loca, "D:/Thèse Metabolomique/Thèse Metabolomique/jardin botanique/data_env_gift_geneve.csv", row.names = FALSE)
