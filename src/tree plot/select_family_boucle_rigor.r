...
family_test <- "Leeaceae"
genus_priority_rigor <- data.frame() 
...
genus_priority_rigor <- rbind(genus_priority_rigor, df_rangement_priority)
}
genus_priority_rigor <- data.frame(genus_priority_rigor)

fix(genus_priority_rigor)
